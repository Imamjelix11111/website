...
function Home () {
    return (
        ...
        <div class="navbar-nav flex mt-8 justify-around text-black font-bold ">
        <img className="w-20 mx-10 h-20" 
 ...
 <h1 class="hero-1 my-3 mx-10 px-10 text-black font-bold text-sm"> HI, Selamat datang di <span>SMK AN-NAHDLIYAH</span></h1>
    <p class="paragraph-hero wh-2 text-black">SMKNU An-Nahdliyah adalah sebuah sekolah menengah kejuruan yang memiliki beberapa bidang
